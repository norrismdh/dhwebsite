    ...
    banner.innerHTML =
      '<div class="dh-consent-banner__inner">' +
        '<div class="dh-consent-banner__text">' +
          ...
          '<p>We use cookies to keep the site running. With your consent we also track performance analytics and campaign attribution. <a href="/Privacy.html#cookies">Learn more</a>.</p>' +
        '</div>' +
